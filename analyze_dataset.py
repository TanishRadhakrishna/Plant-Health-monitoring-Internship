...
def analyze_raw_dataset():
    ...
    if class_stats:
        ...
        if imbalance_ratio > 3:
            print("  ⚠️  HIGH IMBALANCE - Class weights will be used during training")
    ...
    if image_sizes:
        ...
        if small_images > 0:
            print(f"  ⚠️  {small_images} images smaller than 100×100 pixels")
        print()
    ...
    if total_images < 500:
        ...
        recommendations.append("⚠️  Dataset is small (<2000 images)")
    ...
    if class_stats:
        ...
        if min_count < 50:
            ...
            recommendations.append("⚠️  Some classes have <100 samples")
            recommendations.append("   → Recommended: Collect more data")
        
        if imbalance_ratio > 3:
            recommendations.append("⚠️  High class imbalance detected")
