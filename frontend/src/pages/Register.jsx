      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <Link to="/" className="flex items-center justify-center gap-2 mb-8 group">
            <div className="bg-gradient-to-br from-primary-500 to-forest-600 p-3 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-lg">
          ...
          <Card className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Save your diagnosis history and track your plants over time
              </p>
            </div>
