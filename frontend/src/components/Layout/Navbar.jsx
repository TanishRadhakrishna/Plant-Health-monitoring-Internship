      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="bg-gradient-to-br from-primary-500 to-forest-600 p-2 rounded-xl group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="hidden md:flex items-center gap-4">
            {user ? (
              <>
                ...
                <Button variant="outline" onClick={handleLogout} icon={<LogOut size={20} />}>
                  Logout
                </Button>
              </>
            ) : (
              ...
              {user ? (
                <>
                  <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)}>
                    <Button variant="ghost" className="w-full justify-start" icon={<History size={20} />}>
                      My History
                    </Button>
                  </Link>
                  <Link to="/profile" onClick={() => setMobileMenuOpen(false)}>
                    <Button variant="ghost" className="w-full justify-start" icon={<User size={20} />}>
                      Profile
                    </Button>
                  </Link>
                  <Button 
